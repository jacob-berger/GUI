...
public class jbergerLab4 extends Application {
    ...
    public ToolBar buildToolBar() {
    	...
    	toolbar.getItems().addAll(newButton, openButton, saveButton, moveButton, colorButton, widthButton);
