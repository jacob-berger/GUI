...
public class jbergerLab5 extends Application {
	...
	public MenuBar buildMenuBar() {
		...
		fileMenu.getItems().addAll(newMenuItem, openMenuItem, saveMenuItem, saveAsMenuItem, new SeparatorMenuItem(),
				quitMenuItem);
	...
	public ToolBar buildToolBar() {
		...
		toolbar.getItems().addAll(newButton, new Separator(), openButton, new Separator(), saveButton, new Separator(),
	...
	private void onAbout() {
		...
		alert.setHeaderText("Jacob Berger, CSCD370 Lab 5, Winter 2020");
		alert.showAndWait();
	}
...
//				objectOut.writeObject(line.lines);
	...
	private void onMouseReleased(MouseEvent e) {
		...
		if (mPermCanvas.contains(mTo)) {
			...
			Line line = new Line(mFrom, mTo, mBrushSize, (Color) mColor);
